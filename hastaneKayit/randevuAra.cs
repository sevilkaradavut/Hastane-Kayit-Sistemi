...
namespace HastaneKayit
{
    public partial class randevuAra : Form
    {
        ...
        void doktorlariGoster2()
        {
            frm1.uyelerBaglantisi.Open();
            try
            {
                OleDbCommand cmd = new OleDbCommand("Select * From DoktorBilgi ", frm1.uyelerBaglantisi);

                cmd.ExecuteNonQuery();
                OleDbDataReader rd = cmd.ExecuteReader();
                while (rd.Read())
                {
                    comboBox1.Items.Add(rd["doktorAdiSoyadi"].ToString());
        ...
        void HakkimdaidsiniBul()
        {
            try
            {
                frm1.uyelerBaglantisi.Open();
                OleDbCommand cmd = new OleDbCommand("Select * From DoktorBilgi where doktorAdiSoyadi='" + comboBox1.Text + "'", frm1.uyelerBaglantisi);
                cmd.ExecuteNonQuery();
                OleDbDataReader dr = cmd.ExecuteReader();
                while (dr.Read())
                {
                    hakkimda_id = dr["hakkimda_id"].ToString();
                }
                frm1.uyelerBaglantisi.Close();
                HakkimdaGoster();
            }
        ...
        void HakkimdaGoster()
        {
            ...
            try
            {
                OleDbCommand cmd = new OleDbCommand("Select * From DoktorBilgi where hakkimda_id=@id", frm1.uyelerBaglantisi);
                cmd.Parameters.AddWithValue("@id", hakkimda_id);
        ...
        */
        ...
        {
           sikayetIstek dilek = new sikayetIstek();
